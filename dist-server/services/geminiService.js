 ...
 */
const buildQualityPrompt = (config) => {
 ...
 */
const elevatePrompt = async (config) => {
 ...
 */
export const generateFoodMockup = async (base64ImageData, mimeType, config) => {
...
export const generateFoodMockupOriginal = async (base64ImageData, mimeType, config) => {
 ...
 */
export const getCreativeVariations = async (basePrompt) => {
 ...
 */
export const generateWithRetry = async (base64ImageData, mimeType, config, maxRetries = 3) => {
    let lastError = null;
