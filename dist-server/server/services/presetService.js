...
export const getPreset = (type, id) => {
...
export const applyPreset = (presetId) => {
    const recipe = getPreset('shotRecipes', presetId);
    const perspective = recipe ? getPreset('perspectives', recipe.defaultPerspective) : null;
    const setting = recipe ? getPreset('settings', recipe.defaultSetting) : null;
    return {
